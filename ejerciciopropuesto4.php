...
<body class="container mt-5">
    <h2 class="nb-4">Cadena invertida</h2>
    <form action="" method="post">
        <div class="mb-3">
            <label for="texto" class="form-label">Escriba el mensaje</label>
            <input type="text" class="form-control" name="texto" id="texto" required>   
        </div>
        <button type="submit" class="btn btn-primary">Invertir texto</button>
    </form>
